...
const Navbar = () => {
  ...
  return (
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 px-4 bg-bgDarkblue">
        <div className="max-w-container h-full mx-auto py-1 flex items-center justify-between">
            ...
            <ul className="hidden lg:flex gap-7 ">
                <div className="flex items-center gap-1 font-medium text-xl text-white hover:text-cyan-400 cursor-pointer duration-300">
                    <li>Home</li>
                </div>
                <div className="flex items-center gap-1 font-medium text-xl text-white hover:text-cyan-400 cursor-pointer duration-300">
                    <li>Services</li>
