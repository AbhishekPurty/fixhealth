...
const Hero = () => {
  return (
    <div className="h-[110vh] xl:pb-20 md:pb-20 ">
      <div className="container mx-auto h-full">
        {/* In next line use "bg-[url('/fixhealthbg.jpg')] py-[4rem] bg-center bg-no-repeat bg-cover" for whole screen bg */}
        <div className="xl:px-10 flex flex-col xl:flex-row items-center justify-between h-full">
          <div className="mx-10 xl:w-[48%] text-center justify-center xl:text-left">
            ...
            <button className="text-white border-2 border-cyan-400 bg-cyan-400 duration-300 lg:w-auto lg:mx-0 rounded-full gap-3 px-4 py-2 bg-transparent hover:bg-cyan-400">
              Contact Us
            </button>
          </div>
          <div className="xl:flex max-w-[814px]">
